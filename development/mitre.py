...
mitre_tactic_list = ['none', 'reconnaissance', 'resource development', 'initial access', 'execution', 'persistence', 'privelege escalation', 'defense evasion', 'credential access', 'discovery', 'lateral movement', 'collection', 'command and control', 'exfiltration', 'impact']
...
for file in alert_data:
    for line in alert_data[file]:
        ...
        # Check to make sure MITRE Tactics exist
        ...
        # Check to see if the technique is depricated
        try:
